...
export const CAMERA_POSITIONS: {
    ...
    { camera: new Vector3(20, 50, 23), lookAtOffset: new Vector3(-10, -10, -23) },
    { camera: new Vector3(20, 10, 23), lookAtOffset: new Vector3(-10, -10, -23) },
    { camera: new Vector3(30, -4, 52), lookAtOffset: new Vector3(-20, -15, -20) },
    { camera: new Vector3(50, -20, 62), lookAtOffset: new Vector3(0, -10, -20) },
];
...
export const CAMERA_LOOK_AT_COLLISION_POSITIONS: Record<string, { camera: Vector3; lookAtOffset: Vector3 }> = {
    sheep: { camera: new Vector3(18.5, 7, 6), lookAtOffset: new Vector3(2, -1, -2) },
    dog: { camera: new Vector3(12, -13, 44), lookAtOffset: new Vector3(-2, -2, -2) },
    ...
    wolf: { camera: new Vector3(53, -32, 50), lookAtOffset: new Vector3(0, -2, -2) },
};
